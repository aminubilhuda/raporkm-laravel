...
class AbsensiGuruController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('tu.absensi-guru.index', compact('sekolah', 'presensi', 'riwayat'));
    }
    ...
    public function checkIn(Request $request)
    {
        ...
        DB::beginTransaction();
        try {
            $path = $request->file('foto_selfie_in')->store('absensi/tu', 'public');
    ...
    public function checkOut(Request $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('foto_selfie_out')) {
                $data['foto_selfie_out'] = $request->file('foto_selfie_out')->store('absensi/tu', 'public');
            }
    ...
    public function rekap(Request $request)
    {
        ...
        $rekap = PresensiGuruTu::with(['user.ptk'])
            ->where('tahun_pelajaran_id', $sekolah?->tahun_aktif)
            ->where('semester_id', $sekolah?->semester_aktif)
            ->orderBy('tanggal', 'desc')
            ->get()
        ...
        return view('tu.absensi-guru.rekap', compact('sekolah', 'rekap'));
    }
}
