...
return new class extends Migration
{
    ...
    {
        Schema::create('nilai_sumatif_ph', function (Blueprint $table) {
            $table->id();
            ...
            $table->index(['tahun_pelajaran_id', 'semester_id', 'kelas_id', 'mapel_id'], 'nsph_tp_smt_kls_mapel_idx');
    ...
    {
        Schema::dropIfExists('nilai_sumatif_ph');
    }
};
