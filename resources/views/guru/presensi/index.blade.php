...
@section('content')
<div class="space-y-6">
<div><h1 class="text-2xl md:text-3xl font-extrabold text-coral-dark flex items-center gap-2"><x-heroicon-o-clipboard-document-check class="w-7 h-7" /> Presensi Harian</h1><p class="mt-1 text-sm text-gray-500">Input kehadiran siswa per kelas.</p></div>
...
<div class="bg-white rounded-card shadow-card overflow-hidden">
    <form method="POST" action="{{route('guru.presensi.store')}}">@csrf
