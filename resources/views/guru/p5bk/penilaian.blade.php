...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500">{{ $proyekKelas->judul }} · {{ $proyekKelas->proyekTema?->nama }}</p>
        </div>
        <a href="{{ route('guru.project-kelas.index', $proyekKelas->kelas_id) }}" class="btn-secondary text-sm px-3 py-1.5">
    ...
    @if($dimensiList->isNotEmpty())
        ...
        <div class="bg-white rounded-card shadow-card overflow-hidden">
            ...
            <div class="border-t border-gray-100">
                ...
                <form method="POST" action="{{ route('guru.project-kelas.penilaian.store', $proyekKelas) }}">
                    @csrf
