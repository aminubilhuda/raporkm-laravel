...
<head>
    ...
    <title><?php echo e(config('app.name', 'E-Rapor KM')); ?> - Tata Usaha</title>
...
<body class="font-sans antialiased h-full bg-surface-base">
    ...
    <!-- Sidebar -->
    <aside id="sidebar"
        class="fixed inset-y-0 left-0 z-50 w-64 flex flex-col shadow-lg bg-gradient-to-b from-teal-dark to-teal-primary text-white -translate-x-full md:translate-x-0 transition-transform duration-300">
        <?php echo $__env->make('components.sidebar-tu', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </aside>

    <!-- Main -->
    <div class="md:ml-64 min-h-screen flex flex-col">
        <?php echo $__env->make('components.topbar', ['panel' => 'TU'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
</html><?php /**PATH D:\PROJECT\php\laravel\raporkm-laravel\resources\views/layouts/tu.blade.php ENDPATH**/ ?>