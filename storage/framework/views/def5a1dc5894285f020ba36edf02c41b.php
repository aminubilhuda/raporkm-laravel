...
<?php $component->withAttributes(['align' => 'right','width' => '48']); ?>
                     <?php $__env->slot('trigger', null, []); ?> 
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
                            <div x-data="<?php echo \Illuminate\Support\Js::from(['nama' => auth()->user()->nama])->toHtml() ?>" x-text="nama" x-on:profile-updated.window="nama = $event.detail.nama"></div>
...
<?php endif; ?>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="px-4">
                <div class="font-medium text-base text-gray-800" x-data="<?php echo e(json_encode(['nama' => auth()->user()->nama])); ?>" x-text="nama" x-on:profile-updated.window="nama = $event.detail.nama"></div>
...
</nav><?php /**PATH D:\PROJECT\php\laravel\raporkm-laravel\resources\views\livewire/layout/navigation.blade.php ENDPATH**/ ?>