...
<?php endif; ?>
        ...
        <div class="flex gap-2">
            <a href="<?php echo e(route('tu.kesiswaan.import')); ?>" class="btn-primary inline-flex items-center gap-2 whitespace-nowrap bg-sky hover:bg-sky/90">
                <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?> Import
            ...
            <a href="<?php echo e(route('tu.kesiswaan.create')); ?>" class="btn-primary inline-flex items-center gap-2 whitespace-nowrap">
                <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
    ...
    <form method="GET" class="bg-cream rounded-field shadow-card p-4">
        <div class="grid grid-cols-1 sm:grid-cols-4 gap-3">
            <div class="sm:col-span-2">
                ...
                <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="NISN, NIS, atau nama siswa..." class="w-full border-teal-primary/20 rounded-field text-sm py-2 px-3 focus:border-teal-primary focus:ring-2 focus:ring-teal-primary/20 bg-cream">
            </div>
            <div>
                ...
                <select name="kelas_id" onchange="this.form.submit()" class="w-full border-teal-primary/20 rounded-field text-sm py-2 px-3 focus:border-teal-primary focus:ring-2 focus:ring-teal-primary/20 bg-cream">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $kelass; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($k->id); ?>" <?php echo e(request('kelas_id') == $k->id ? 'selected' : ''); ?>>
                            <?php echo e($k->nama_kelas); ?> (<?php echo e($k->tingkat->nama ?? '-'); ?>)
                        </option>
...
<?php endif; ?> Cari
                ...
                <a href="<?php echo e(route('tu.kesiswaan.index')); ?>" class="px-4 py-2 text-sm font-bold text-gray-600 bg-gray-100 hover:bg-gray-200 rounded-field transition-colors">
                    Reset
                </a>
            </div>
        </div>
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-teal-bg/30">
                        <td class="px-4 py-3 font-bold text-gray-800"><?php echo e($s->nama_siswa); ?></td>
                        <td class="px-4 py-3 text-teal-primary font-bold"><?php echo e($s->nisn); ?></td>
                        <td class="px-4 py-3 text-gray-500 hidden md:table-cell"><?php echo e($s->nis); ?></td>
                        <td class="px-4 py-3 hidden sm:table-cell">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($s->kelamin == 1): ?>
                                <span class="text-sky font-bold">L</span>
                            <?php elseif($s->kelamin == 2): ?>
                        ...
                        <td class="px-4 py-3 hidden md:table-cell">
                            <?php $kelasAktif = $s->siswaKelas->firstWhere('status', 'aktif'); ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($kelasAktif): ?>
                                <span class="px-2 py-0.5 rounded-field bg-teal-primary/10 text-teal-primary font-bold text-xs"><?php echo e($kelasAktif->kelas?->nama_kelas ?? '-'); ?></span>
                            <?php else: ?>
                                <span class="text-gray-400">-</span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </td>
                        <td class="px-4 py-3 text-gray-500 hidden lg:table-cell"><?php echo e($s->siswaKelas->last()?->kelas?->kompetensiKeahlian?->nama ?? '-'); ?></td>
                        <td class="px-4 py-3 text-right">
                            <div class="flex items-center justify-end gap-1">
                                <button type="button" onclick="showDetail(<?php echo e($s->id); ?>)" class="p-1.5 text-teal-primary hover:bg-teal-bg rounded-lg" title="Detail">
                                    <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                                ...
                                <button type="button" onclick="editSiswa(<?php echo e($s->id); ?>)" class="p-1.5 text-sky hover:bg-sky/5 rounded-lg" title="Edit"><?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?></button>
                                <form method="POST" action="<?php echo e(route('tu.kesiswaan.destroy', $s)); ?>" class="inline" onsubmit="return confirm('Nonaktifkan siswa ini?')">
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-12 h-12 mx-auto mb-2 text-gray-300']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request('search') || request('kelas_id')): ?>
        ...
        <div class="px-4 py-3 border-t border-gray-100 flex items-center justify-between">
            <p class="text-xs text-gray-400">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($siswa instanceof \Illuminate\Pagination\LengthAwarePaginator): ?>
                    Menampilkan <?php echo e($siswa->firstItem() ?? 0); ?>–<?php echo e($siswa->lastItem() ?? 0); ?> dari <?php echo e($siswa->total()); ?> siswa
                <?php else: ?>
...
<script>
    ...
    async function showDetail(id) {
        ...
        try {
            const res = await fetch('<?php echo e(url("tu/kesiswaan")); ?>/' + id);
    ...
    async function editSiswa(id) {
        ...
        try {
            const res = await fetch('<?php echo e(url("tu/kesiswaan")); ?>/' + id + '/edit');
            if (!res.ok) throw new Error('Gagal memuat data');
            ...
            // Set form action
            editForm.action = '<?php echo e(url("tu/kesiswaan")); ?>/' + s.id;
...
<?php echo $__env->make('layouts.tu', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT\php\laravel\raporkm-laravel\resources\views/tu/kesiswaan/index.blade.php ENDPATH**/ ?>