...
<div class="space-y-6">
    <div>
        <h1 class="text-2xl md:text-3xl font-extrabold <?php echo e(auth()->user()->jabatan == 2 ? 'text-teal-primary-dark' : 'text-coral-dark'); ?> flex items-center gap-2">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = \App\Models\SiswaKelas::where('kelas_id', $kelas->id)
                        ->where('tahun_pelajaran_id', $taId)
                        ->where('semester_id', $semesterId)
                        ->with('siswa')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $sk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50 transition-colors">
                        <td class="px-4 py-3 text-gray-400 font-bold"><?php echo e($i + 1); ?></td>
                        <td class="px-4 py-3 font-bold text-gray-800"><?php echo e($sk->siswa->nama_siswa ?? '-'); ?></td>
                        <td class="px-4 py-3 text-gray-600 hidden sm:table-cell"><?php echo e($sk->siswa->nisn ?? '-'); ?></td>
                        <td class="px-4 py-3 text-right">
                            <div class="flex items-center justify-end gap-1">
                                <a href="<?php echo e(route('rapor.pdf', ['kelas' => $kelas, 'siswa' => $sk->siswa_id])); ?>"
...
<?php endif; ?>
                                ...
                                <a href="<?php echo e(route('rapor.pdf-mid', ['kelas' => $kelas, 'siswa' => $sk->siswa_id])); ?>"
...
<?php echo $__env->make(auth()->user()->jabatan == 2 ? 'layouts.tu' : 'layouts.guru', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT\php\laravel\raporkm-laravel\resources\views\rapor\index.blade.php ENDPATH**/ ?>