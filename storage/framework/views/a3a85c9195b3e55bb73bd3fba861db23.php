...
<section>
    <header>
        <h2 class="text-lg font-extrabold text-teal-primary-dark">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['wire:model' => 'nama','id' => 'nama','name' => 'nama','type' => 'text','class' => 'mt-1 block w-full','required' => true,'autofocus' => true,'autocomplete' => 'name']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'nama','id' => 'nama','name' => 'nama','type' => 'text','class' => 'mt-1 block w-full','required' => true,'autofocus' => true,'autocomplete' => 'name']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
</section><?php /**PATH D:\PROJECT\php\laravel\raporkm-laravel\resources\views\livewire\profile\update-profile-information-form.blade.php ENDPATH**/ ?>