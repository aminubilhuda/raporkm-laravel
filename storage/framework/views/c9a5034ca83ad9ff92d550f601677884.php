...
<?php endif; ?>
    ...
    <div class="grid md:grid-cols-3 gap-4">
        ...
        <div class="bg-white rounded-card shadow-card p-5 border-l-[6px] border-l-teal-primary">
            ...
            <form method="GET" action="<?php echo e(route('tu.ekspor.nilai')); ?>" class="space-y-2" onsubmit="showLoading(this)">
                ...
                <select name="tahun" required class="w-full border-gray-300 rounded-pill px-3 py-2 text-sm">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $tahunList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($tp->id); ?>" <?php echo e($tp->status ? 'selected' : ''); ?>><?php echo e($tp->tahun); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </select>
                <select name="semester" required class="w-full border-gray-300 rounded-pill px-3 py-2 text-sm">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $semesterList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($s->id); ?>" <?php echo e($s->status ? 'selected' : ''); ?>><?php echo e($s->nama); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </select>
...
<?php $component = $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?> <span class="btn-text">Export Nilai</span>
                </button>
            </form>
        </div>
        ...
        <div class="bg-white rounded-card shadow-card p-5 border-l-[6px] border-l-coral">
            ...
            <form method="GET" action="<?php echo e(route('tu.ekspor.presensi')); ?>" class="space-y-2" onsubmit="showLoading(this)">
                <select name="kelas_id" required class="w-full border-gray-300 rounded-pill px-3 py-2 text-sm">
                    <option value="">— Kelas —</option>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $kelasList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($k->id); ?>"><?php echo e($k->nama_kelas); ?></option>
...
<?php $component = $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?> <span class="btn-text">Export Presensi</span>
                </button>
            </form>
        </div>
        ...
        <div class="bg-white rounded-card shadow-card p-5 border-l-[6px] border-l-sky">
            ...
            <form method="GET" action="<?php echo e(route('tu.ekspor.siswa')); ?>" class="space-y-2" onsubmit="showLoading(this)">
...
<?php $component = $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?> <span class="btn-text">Export Siswa</span>
                </button>
            </form>
        </div>
    </div>
...
<?php echo $__env->make('layouts.tu', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT\php\laravel\raporkm-laravel\resources\views\tu\ekspor\index.blade.php ENDPATH**/ ?>