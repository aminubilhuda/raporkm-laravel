...
<?php $component->withName('heroicon-o-cloud-arrow-down'); ?>
...
<?php endif; ?> Dapodik</h1><p class="mt-1 text-sm text-gray-500">Sinkronisasi data dari API Dapodik.</p></div>
...
<div class="bg-white rounded-card shadow-card p-5 md:p-6 border-l-[6px] border-l-teal-primary">
    ...
    <form method="POST" action="<?php echo e(route('tu.dapodik.config')); ?>" class="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
        <?php echo csrf_field(); ?>
        <div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['name' => 'url','value' => $config['url'],'placeholder' => '192.168.11.207','class' => 'block w-full','required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'url','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($config['url']),'placeholder' => '192.168.11.207','class' => 'block w-full','required' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div>
            ...
            <?php if (isset($component)) { $__componentOriginal18c21970322f9e5c938bc954620c12bb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal18c21970322f9e5c938bc954620c12bb = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['name' => 'npsn','value' => $config['npsn'],'placeholder' => '20505005','class' => 'block w-full','required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('text-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'npsn','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($config['npsn']),'placeholder' => '20505005','class' => 'block w-full','required' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal18c21970322f9e5c938bc954620c12bb)): ?>
<?php $attributes = $__attributesOriginal18c21970322f9e5c938bc954620c12bb; ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div>
            ...
            <?php if (isset($component)) { $__componentOriginal18c21970322f9e5c938bc954620c12bb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal18c21970322f9e5c938bc954620c12bb = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['name' => 'token','value' => $config['token'],'placeholder' => 'Bearer token','class' => 'block w-full','required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('text-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'token','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($config['token']),'placeholder' => 'Bearer token','class' => 'block w-full','required' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal18c21970322f9e5c938bc954620c12bb)): ?>
<?php $attributes = $__attributesOriginal18c21970322f9e5c938bc954620c12bb; ?>
...
<?php unset($__componentOriginal18c21970322f9e5c938bc954620c12bb); ?>
<?php endif; ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['token'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="text-coral text-sm mt-1"><?php echo e($message); ?></p><?php unset($message);
...
<div class="bg-white rounded-card shadow-card p-5 md:p-6 border-l-[6px] border-l-gold">
    ...
    <form method="POST" action="<?php echo e(route('tu.dapodik.sync', 'all')); ?>" class="mb-4">
        <?php echo csrf_field(); ?>
        <button class="w-full flex items-center gap-3 p-4 bg-gold/10 rounded-card hover:bg-gold/20 transition-colors text-left border-2 border-dashed border-gold/40">
            <span class="flex-shrink-0 w-12 h-12 rounded-full bg-gold shadow-accent-glow flex items-center justify-center"><?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-6 h-6 text-gold-dark']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php endif; ?>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <form method="POST" action="<?php echo e(route('tu.dapodik.sync', 'sekolah')); ?>">
            <?php echo csrf_field(); ?>
            <button class="w-full flex items-center gap-3 p-4 bg-surface-base rounded-card hover:bg-teal-bg/50 transition-colors text-left">
                <span class="flex-shrink-0 w-10 h-10 rounded-full bg-teal-primary/10 flex items-center justify-center"><?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
        ...
        <form method="POST" action="<?php echo e(route('tu.dapodik.sync', 'peserta-didik')); ?>">
            <?php echo csrf_field(); ?>
            <button class="w-full flex items-center gap-3 p-4 bg-surface-base rounded-card hover:bg-teal-bg/50 transition-colors text-left">
                <span class="flex-shrink-0 w-10 h-10 rounded-full bg-teal-primary/10 flex items-center justify-center"><?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
...
<?php endif; ?>
        ...
        <form method="POST" action="<?php echo e(route('tu.dapodik.sync', 'rombongan-belajar')); ?>">
            <?php echo csrf_field(); ?>
            <button class="w-full flex items-center gap-3 p-4 bg-surface-base rounded-card hover:bg-teal-bg/50 transition-colors text-left">
                <span class="flex-shrink-0 w-10 h-10 rounded-full bg-teal-primary/10 flex items-center justify-center"><?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
...
<?php endif; ?>
        ...
        <form method="POST" action="<?php echo e(route('tu.dapodik.sync', 'gtk')); ?>">
            <?php echo csrf_field(); ?>
            <button class="w-full flex items-center gap-3 p-4 bg-surface-base rounded-card hover:bg-teal-bg/50 transition-colors text-left">
                <span class="flex-shrink-0 w-10 h-10 rounded-full bg-teal-primary/10 flex items-center justify-center"><?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
...
<?php endif; ?>
        ...
        <form method="POST" action="<?php echo e(route('tu.dapodik.sync', 'pembelajaran')); ?>">
            <?php echo csrf_field(); ?>
            <button class="w-full flex items-center gap-3 p-4 bg-surface-base rounded-card hover:bg-teal-bg/50 transition-colors text-left">
                <span class="flex-shrink-0 w-10 h-10 rounded-full bg-teal-primary/10 flex items-center justify-center"><?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
...
<?php endif; ?>
        ...
        <form method="POST" action="<?php echo e(route('tu.dapodik.sync', 'pengguna')); ?>">
            <?php echo csrf_field(); ?>
            <button class="w-full flex items-center gap-3 p-4 bg-surface-base rounded-card hover:bg-teal-bg/50 transition-colors text-left">
                <span class="flex-shrink-0 w-10 h-10 rounded-full bg-teal-primary/10 flex items-center justify-center"><?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($logs->isNotEmpty()): ?>
<div class="bg-white rounded-card shadow-card overflow-hidden">
    <div class="px-4 py-3 border-b flex items-center justify-between">
        <h2 class="font-extrabold text-teal-primary-dark">Riwayat Sinkronisasi</h2>
        <a href="<?php echo e(route('tu.dapodik.log')); ?>" class="text-sm text-teal-primary font-bold hover:underline">Lihat Semua</a>
    </div>
    ...
    <tbody class="divide-y"><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><tr class="hover:bg-teal-bg/30"><td class="px-4 py-3 font-bold"><?php echo e($l->endpoint); ?></td>
    <td class="px-4 py-3"><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($l->status === 'success'): ?><span class="text-success font-bold">✓ Sukses</span><?php elseif($l->status === 'batch_started'): ?><span class="text-teal-primary font-bold animate-pulse">⏳ Diproses</span><?php else: ?><span class="text-coral font-bold">✗ Gagal</span><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?></td>
    <td class="px-4 py-3"><?php echo e($l->records_count); ?></td>
    <td class="px-4 py-3 hidden lg:table-cell text-gray-500"><?php echo e($l->created_at->format('d/m/Y H:i')); ?></td></tr><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?></tbody></table>
    </div>
</div>
...
<?php echo $__env->make('layouts.tu', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT\php\laravel\raporkm-laravel\resources\views/tu/dapodik/index.blade.php ENDPATH**/ ?>