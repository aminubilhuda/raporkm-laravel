...
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('heroicon-m-camera'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
    ...
    <div class="bg-white rounded-card shadow-card p-5 md:p-6 border-l-[6px] border-l-coral">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($presensi): ?>
            <div class="mb-4 p-4 bg-blue-50 border border-blue-200 rounded-card">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($presensi->check_in): ?>
                    <p class="text-sm mt-2">✅ Check-in: <?php echo e($presensi->check_in); ?> (<?php echo e($presensi->status_check_in); ?>)</p>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($presensi->check_out): ?>
                    <p class="text-sm mt-1">✅ Check-out: <?php echo e($presensi->check_out); ?> (<?php echo e($presensi->status_check_out); ?>)</p>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

        <form id="absensiForm" method="POST" action="<?php echo e(route('guru.absensi-guru.check-in')); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="mt-6 flex gap-3">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$presensi || !$presensi->check_in): ?>
...
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('heroicon-m-arrow-left-on-rectangle'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y">
                    ...
                    <tr class="hover:bg-coral-bg/30">
                        <td class="px-4 py-3"><?php echo e(\Carbon\Carbon::parse($r->tanggal)->format('d/m/Y')); ?></td>
                        <td class="px-4 py-3"><?php echo e($r->check_in ?? '-'); ?></td>
                        <td class="px-4 py-3">
                            <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-bold
                                <?php echo e($r->status_check_in === 'tepat_waktu' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'); ?>">
                                <?php echo e($r->status_check_in === 'tepat_waktu' ? 'Tepat Waktu' : 'Terlambat'); ?>

                            </span>
                        </td>
                        <td class="px-4 py-3"><?php echo e($r->check_out ?? '-'); ?></td>
                        <td class="px-4 py-3">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($r->status_check_out === 'pulang_tepat'): ?>
                                <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-bold bg-green-100 text-green-800">Tepat</span>
                            <?php elseif($r->status_check_out === 'pulang_cepat'): ?>
...
document.addEventListener('DOMContentLoaded', function() {
    const sekolahLat = <?php echo e($sekolah?->latitude ?? -6.9); ?>;
    const sekolahLng = <?php echo e($sekolah?->longitude ?? 112.0); ?>;
    const radius = <?php echo e($sekolah?->radius_absen ?? 100); ?>;
    ...
    async function submitCheckIn() {
        ...
        try {
            const response = await fetch('<?php echo e(route("guru.absensi-guru.check-in")); ?>', {
                method: 'POST',
                headers: {
    ...
    async function submitCheckOut() {
        ...
        try {
            const response = await fetch('<?php echo e(route("guru.absensi-guru.check-out")); ?>', {
                method: 'POST',
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('input[name="_token"]').value,
                    'Accept': 'application/json'
...
<?php echo $__env->make('layouts.guru', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT\php\laravel\raporkm-laravel\resources\views/guru/absensi/index.blade.php ENDPATH**/ ?>