...
<?php endif; ?> Absensi BK</h1><p class="mt-1 text-sm text-gray-500">Catatan bimbingan konseling.</p></div>
...
<div class="bg-white rounded-card shadow-card overflow-hidden">
    <form method="POST" action="<?php echo e(route('guru.absensi-bk.store')); ?>"><?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.guru', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT\php\laravel\raporkm-laravel\resources\views/guru/absensi-bk/index.blade.php ENDPATH**/ ?>