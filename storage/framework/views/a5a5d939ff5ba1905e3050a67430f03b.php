            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-teal-bg/30">
                        ...
                        <td class="px-4 py-3 text-gray-500 hidden sm:table-cell"><?php echo e($s->kelamin == 1 ? 'L' : ($s->kelamin == 2 ? 'P' : '-')); ?></td>
                        <td class="px-4 py-3 text-gray-500 hidden md:table-cell"><?php echo e($s->siswaKelas->last()?->kelas?->nama_kelas ?? '-'); ?></td>
...
<?php endif; ?></button>
        ...
        <div class="px-4 py-3 border-t border-gray-100"><?php echo e($siswa->links()); ?></div>
    </div>
</div>
...
<?php echo $__env->make('layouts.tu', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT\php\laravel\raporkm-laravel\resources\views\tu\kesiswaan\index.blade.php ENDPATH**/ ?>