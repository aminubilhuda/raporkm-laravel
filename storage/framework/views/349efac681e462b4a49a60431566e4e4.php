        ...
        <div class="grid grid-cols-1 sm:grid-cols-4 gap-3">
            <div>
                ...
                <select name="tahun_pelajaran_id" onchange="this.form.submit()" class="w-full border-teal-primary/20 rounded-field text-sm py-2 px-3 focus:border-teal-primary focus:ring-2 focus:ring-teal-primary/20 bg-cream">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $tpList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($tp->id); ?>" <?php echo e($selectedTp == $tp->id ? 'selected' : ''); ?>><?php echo e($tp->tahun); ?></option>
            ...
            <div>
                ...
                <select name="semester_id" onchange="this.form.submit()" class="w-full border-teal-primary/20 rounded-field text-sm py-2 px-3 focus:border-teal-primary focus:ring-2 focus:ring-teal-primary/20 bg-cream">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $semesterList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($s->id); ?>" <?php echo e($selectedSemester == $s->id ? 'selected' : ''); ?>><?php echo e($s->nama); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </select>
            </div>
            <div>
                ...
                <select name="kelas_id" onchange="this.form.submit()" class="w-full border-teal-primary/20 rounded-field text-sm py-2 px-3 focus:border-teal-primary focus:ring-2 focus:ring-teal-primary/20 bg-cream" required>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $kelasList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($k->id); ?>" <?php echo e($selectedKelas == $k->id ? 'selected' : ''); ?>><?php echo e($k->nama_kelas); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </select>
            </div>
...
<?php endif; ?> Cari
                ...
                <a href="<?php echo e(route('tu.mapel-siswa.index')); ?>" class="btn-secondary py-2 text-sm text-center">
                    Reset
                </a>
            </div>
        </div>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($selectedKelas && $siswaList->isNotEmpty() && $mapelList->isNotEmpty()): ?>
        <div class="bg-white rounded-card shadow-card overflow-hidden border-l-[6px] border-l-teal-primary">
            <form method="POST" action="<?php echo e(route('tu.mapel-siswa.batch-update')); ?>">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="kelas_id" value="<?php echo e($selectedKelas); ?>">
                <input type="hidden" name="tahun_pelajaran_id" value="<?php echo e($selectedTp); ?>">
                <input type="hidden" name="semester_id" value="<?php echo e($selectedSemester); ?>">
                    ...
                    <table class="w-full text-sm">
                        <thead class="bg-surface-base">
                            <tr>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $mapelList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <th class="px-3 py-3 font-extrabold text-xs uppercase text-gray-500 text-center whitespace-nowrap" title="<?php echo e($mk->mapel->nama_mapel); ?>">
                                        <div class="flex flex-col items-center gap-1">
                                            <span><?php echo e($mk->short_name); ?></span>
                                            <input type="checkbox" onclick="toggleColumn(this, 'col-<?php echo e($mk->id); ?>')" class="rounded border-teal-primary/20 text-teal-primary focus:ring-teal-primary/30 w-3.5 h-3.5 cursor-pointer">
                                        </div>
                                    </th>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </tr>
                        ...
                        <tbody class="divide-y divide-gray-100">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $siswaList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-teal-bg/20">
                                    <td class="px-4 py-3 font-bold text-gray-800 sticky left-0 bg-white hover:bg-teal-bg/20 z-10 border-r border-gray-100"><?php echo e($s->nama_siswa); ?></td>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $mapelList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                            $checked = isset($assignments[$s->id][$mk->id]);
                                        ?>
                                        <td class="px-3 py-3 text-center">
                                            <input type="checkbox" name="mapel[<?php echo e($s->id); ?>][<?php echo e($mk->id); ?>]" value="1" <?php echo e($checked ? 'checked' : ''); ?> class="col-<?php echo e($mk->id); ?> rounded border-teal-primary/20 text-teal-primary focus:ring-teal-primary/30 w-4 h-4 cursor-pointer">
                                        </td>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php echo $__env->make('layouts.tu', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT\php\laravel\raporkm-laravel\resources\views/tu/mapel-siswa/index.blade.php ENDPATH**/ ?>